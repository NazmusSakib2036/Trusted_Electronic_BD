...
const districts = {
  ...
  dhaka: [{ value: "dhaka", label: "Dhaka" }],
  others: [{ value: "narayanganj", label: "Narayanganj" }],
};
const upazilas = {
  "": [{ value: "", label: "Select Upazila / P.O" }],
  dhaka: [{ value: "ramna", label: "Ramna" }],
  narayanganj: [{ value: "bandar", label: "Bandar" }],
};
        ...
        <div className="place-order-section">
          ...
          <div className="form-group phone-group">
            ...
            <div className="phone-input-wrapper">
              ...
              <input type="text" id="phone" placeholder="8801313********" />
            </div>
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="text" id="address" placeholder="Savar Heymatpur (Singair Manikgonj)" />
          </div>
          <div className="form-group select-group">
            <label htmlFor="division">Division</label>
            <select id="division" className="form-select" onChange={handleDivisionChange} value={selectedDivision}>
              {divisions.map((div) => (
          ...
          <div className="form-group select-group">
            ...
            <select id="district" className="form-select" onChange={handleDistrictChange} value={selectedDistrict}>
          ...
          <div className="form-group select-group">
            ...
            <select id="upazila" className="form-select" onChange={(e) => setSelectedUpazila(e.target.value)} value={selectedUpazila}>
          ...
          <button className="confirm-order-btn" onClick={handleConfirmOrder} disabled={!isTermsAccepted}>
